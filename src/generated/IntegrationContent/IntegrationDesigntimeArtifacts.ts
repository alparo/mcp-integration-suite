...
import {
  ...
  DesignGuidelineExecutionResultsType
} from './DesignGuidelineExecutionResults';
  ...
  implements IntegrationDesigntimeArtifactsType<T>
{
  ...
  /**
   * One-to-many navigation property to the {@link DesignGuidelineExecutionResults} entity.
   */
  declare designGuidelineExecutionResults: DesignGuidelineExecutionResults<T>[];
...
> {
  ...
  designGuidelineExecutionResults: DesignGuidelineExecutionResultsType<T>[];
}
