    ...
    EntityApi<IntegrationDesigntimeArtifacts<DeSerializersT>, DeSerializersT>
{
  ...
  private navigationPropertyFields!: {
    ...
    >;
    /**
     * Static representation of the one-to-many navigation property {@link designGuidelineExecutionResults} for query construction.
     * Use to reference this property in query operations such as 'select' in the fluent request API.
     */
    DESIGN_GUIDELINE_EXECUTION_RESULTS: Link<
      IntegrationDesigntimeArtifacts<DeSerializersT>,
      DeSerializersT,
  ...
  _addNavigationProperties(
    ...
    this.navigationPropertyFields = {
      ...
      DESIGN_GUIDELINE_EXECUTION_RESULTS: new Link(
