...
> {
  ...
  get integrationDesigntimeArtifactsApi(): IntegrationDesigntimeArtifactsApi<DeSerializersT> {
    ...
    const linkedApis = [
      ...
      this.initApi(
        'designGuidelineExecutionResultsApi',
        DesignGuidelineExecutionResultsApi
      )
    ];
  ...
  get designGuidelineExecutionResultsApi(): DesignGuidelineExecutionResultsApi<DeSerializersT> {
    const api = this.initApi(
      'designGuidelineExecutionResultsApi',
      DesignGuidelineExecutionResultsApi
    );
    const linkedApis = [
      this.initApi('designGuidelinesApi', DesignGuidelinesApi)
    ];
    api._addNavigationProperties(linkedApis);
    return api;
  }

  get designGuidelinesApi(): DesignGuidelinesApi<DeSerializersT> {
    return this.initApi('designGuidelinesApi', DesignGuidelinesApi);
  }
